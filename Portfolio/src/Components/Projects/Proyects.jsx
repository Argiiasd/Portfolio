        ...
        <div className={styles.Proyects} id='proyectos'>
            ...
            <div className={styles.Proyect}>
                    ...
                    <div className={styles.Proyect_Body}>
                        <h2 className={styles.Proyect_Title}>MaskotApp - Social Network for pets</h2>
                        <p className={styles.Proyect_Info}>MaskotApp is a social network where you can share your pets, and know others. <br/>Design by Mariana Guadalupe Miño.</p>
                        <NavLink disabled={true} className={styles.Proyect_Button}>Deploy (soon)</NavLink>
                    </div>
                </div>
                <div className={styles.Proyect}>
